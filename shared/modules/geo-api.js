...
const GeoAPI = (function() {
    ...
    // Version configuration - paths relative to frontend folder
    const VERSION_CONFIG = {
        '2023': {
            key: '2023',
            name: 'Roads 2023',
            displayName: 'Roads 2023',
            folder: '../data_warehouse/roads/roads_by_region',
            color: '#f97316',
        ...
        '2024': {
            ...
            folder: '../data_warehouse/roads/roads_by_region_2024_07_23',
        ...
        'latest': {
            ...
            folder: '../data_warehouse/roads/roads_by_region_latest',
